...
Go 1发布后，我们知道我们需要花时间在生产环境中使用Go。 我们在自己的项目中使用Go，并改进了实现：我们移植到许多新系统，我们重写了几乎每个关键性能部分，使Go运行更有效率，我们还添加了关键工具，如[race detector](https://blog.golang.org/race-detector)
...
## 需要帮助
### 我们需要你的帮助
Go 2的讨论从今天开始，它将出现在公开场合，如邮件列表和问题跟踪器等公共论坛中。请在沿途的每一步帮助我们。
